...
class MakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create make" do
    assert_difference('Make.count') do
      post makes_url, params: { make: { brand: @make.brand, model: @make.model, type: @make.type } }
    end
  ...
  test "should update make" do
    patch make_url(@make), params: { make: { brand: @make.brand, model: @make.model, type: @make.type } }
