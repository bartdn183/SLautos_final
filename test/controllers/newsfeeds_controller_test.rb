...
class NewsfeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newsfeed" do
    assert_difference('Newsfeed.count') do
      post newsfeeds_url, params: { newsfeed: { message: @newsfeed.message, title: @newsfeed.title, user_id: @newsfeed.user_id } }
    end
  ...
  test "should update newsfeed" do
    patch newsfeed_url(@newsfeed), params: { newsfeed: { message: @newsfeed.message, title: @newsfeed.title, user_id: @newsfeed.user_id } }
